...
int ad917x_jesd_config_datapath(ad917x_handle_t *h, uint8_t dual_en,
...
int ad917x_jesd_get_cfg_status(ad917x_handle_t *h, uint8_t *cfg_valid)
{
	int err;
	uint8_t tmp_reg;
...
int ad917x_jesd_get_cfg_param(ad917x_handle_t *h,
...
int ad917x_jesd_set_scrambler_enable(ad917x_handle_t *h, uint8_t en)
{
	int err;
...
int ad917x_jesd_enable_datapath(ad917x_handle_t *h,
...
int ad917x_jesd_set_syncoutb_enable(ad917x_handle_t *h,
...
int ad917x_jesd_get_pll_status(ad917x_handle_t *h, uint8_t *pll_status)
{
	int err;
...
int ad917x_jesd_set_lane_xbar(ad917x_handle_t *h,
...
int ad917x_jesd_invert_lane(ad917x_handle_t *h,
...
int ad917x_jesd_get_lane_xbar(ad917x_handle_t *h, uint8_t *phy_log_map)
{
	int i, err;
	uint8_t tmp_reg;
...
int ad917x_jesd_enable_link(ad917x_handle_t *h,
...
int ad917x_jesd_get_link_status(ad917x_handle_t *h, jesd_link_t link,
...
int ad917x_jesd_set_lmfc_delay(ad917x_handle_t *h, jesd_link_t link,
