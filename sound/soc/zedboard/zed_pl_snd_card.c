...
// static struct snd_soc_dai_link_component xlnx_i2s_capture_cpus[] = {
// 	{
// 		.dai_name = "xlnx_i2s_capture",
// 	},
// };

// static struct snd_soc_dai_link_component xlnx_i2s_capture_codecs[] = {
// 	{
// 		.name = NULL,
// 		.dai_name = "adau-hifi",
// 	},
...
// static struct snd_soc_dai_link_component xlnx_i2s_capture_platforms[] = {
// 	{
// 		.name = NULL
// 	}
// }
...
static int zed_snd_probe(struct platform_device *pdev)
{
	...
	printk("ZED: debug probe 000\n");

	if (!node)
		return -ENODEV;
	printk("ZED: debug probe 00\n");

	card = devm_kzalloc(&pdev->dev, sizeof(struct snd_soc_card),
			    GFP_KERNEL);
	if (!card)
		return -ENOMEM;
	printk("ZED: debug probe 0\n");
...
MODULE_AUTHOR("Cyril Zwahlen & Yuhei Horibe");
